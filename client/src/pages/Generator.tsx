        ...
        <div className="flex gap-20 max-sm:flex-col items-start justify-between">
          ...
          <div className="w-full">
            <div className="mb-4 text-gray-300">
              ...
              <div className="mb-4 text-gray-300 justify-center">
                <label className="block text-sm mb-4">Aspect Ratio
                </label>
                <div><RectangleVerticalIcon onClick={()=>setAspectRatio('9:16')} className={`p-2.5 size-13 bg-white/6 rounded transition-all ring-2 ring-transparent cursor-pointer${aspectRatio==='9:16'?'ring-violet-500/50 bg-white/10':''}`}/></div>
            ...
            <div className="mb-4 text-gray-300">
                <label htmlFor="userPrompt" className="block text-sm mb-4" >User Prompt
                  <span className="text-xs text-violet-400">
                    (optional)
                  </span>
                </label>
